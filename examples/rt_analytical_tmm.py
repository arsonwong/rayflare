...
surf_pyr_upright = regular_pyramids(upright=True, elevation_angle=54.74, random_positions=False)
surf_planar = planar_surface()
front_surf_pyr = Interface(
    "RT_analytical_TMM", layers=front_materials, texture=surf_pyr_upright, name="SiN_RT", coherent=True
)
...
Tfirst = np.array(RAT['Tfirst'])
A = 1 - R - Tfirst
data = np.loadtxt(os.path.join(current_dir, r"PVL_benchmark", r"teststruct26_results.csv"), skiprows=0, delimiter=',')
data = np.array(data)
plt.plot(wl, R, label='R(Rayflare) regular texture',color='orange', linestyle='-')
plt.plot(wl, Tfirst, label='T(Rayflare) regular texture',color='blue', linestyle='-')
plt.plot(wl, A, label='A(Rayflare) regular texture',color='magenta', linestyle='-')
plt.plot(data[:,0], data[:,2], label='R(PVL) regular texture',color='orange', linestyle='--')
plt.plot(data[:,0], data[:,4], label='T(PVL) regular texture',color='blue', linestyle='--')
plt.plot(data[:,0], data[:,3], label='A(PVL) regular texture',color='magenta', linestyle='--')
plt.title('air-Si, \nupright pyramid texture 54.74 degrees, incident angle = 0')
plt.xlabel('Wavelength (nm)')
plt.ylabel('RAT')
plt.ylim(0, 1)
# plt.legend(loc=0)
...
surf_pyr_upright = regular_pyramids(upright=True, elevation_angle=54.74, random_positions=True)
surf_planar = planar_surface()
front_surf_pyr = Interface(
    "RT_analytical_TMM", layers=front_materials, texture=surf_pyr_upright, name="SiN_RT", coherent=True
)
...
Tfirst = np.array(RAT['Tfirst'])
A = 1 - R - Tfirst
data = np.loadtxt(os.path.join(current_dir, r"PVL_benchmark", r"teststruct27_results.csv"), skiprows=0, delimiter=',')
data = np.array(data)
plt.plot(wl, R, label='R(Rayflare) random texture',color='red', linestyle='-')
plt.plot(wl, Tfirst, label='T(Rayflare) random texture',color='green', linestyle='-')
plt.plot(wl, A, label='A(Rayflare) random texture',color='purple', linestyle='-')
plt.plot(data[:,0], data[:,2], label='R(PVL) random texture',color='red', linestyle='--')
plt.plot(data[:,0], data[:,4], label='T(PVL) random texture',color='green', linestyle='--')
plt.plot(data[:,0], data[:,3], label='A(PVL) random texture',color='purple', linestyle='--')
plt.title('air-Si, \nupright pyramid texture 54.74 degrees, incident angle = 0')
plt.xlabel('Wavelength (nm)')
plt.ylabel('RAT')
plt.ylim(0, 1)
...
surf_pyr_upright = regular_pyramids(upright=False, elevation_angle=54.74, random_positions=True)
surf_planar = planar_surface()
front_surf_pyr = Interface(
    "RT_analytical_TMM", layers=front_materials, texture=surf_pyr_upright, name="SiN_RT", coherent=True
)
...
Tfirst = np.array(RAT['Tfirst'])
A = 1 - R - Tfirst
data = np.loadtxt(os.path.join(current_dir, r"PVL_benchmark", r"teststruct28_results.csv"), skiprows=0, delimiter=',')
data = np.array(data)
plt.plot(wl, R, label='R(Rayflare) random texture',color='red', linestyle='-')
plt.plot(wl, Tfirst, label='T(Rayflare) random texture',color='green', linestyle='-')
plt.plot(wl, A, label='A(Rayflare) random texture',color='purple', linestyle='-')
